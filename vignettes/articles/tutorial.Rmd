...
| Spalte | Klasse | |-----------------|---------| | **"starttime"** | POSIXct | | **"site"** | factor | |
**"parameter"** | factor | | **"interval"** | factor | | **"unit"** | factor | | **"value"** | double |
...
|-----------|---------------------------|------------------------------------------| | ta1towb0 | Bürgerliche
Stundenmittel | Lufttemperatur, Instrument 1 | | ta1towh0 | Stundenmittel | Lufttemperatur, Instrument 1 | | ta1tows0 |
Momentanwerte | Lufttemperatur, Instrument 1 | | fk1towz0 | Zehnminutenmittel | Windgeschwindigkeit skalar, Instrument
1 |
...
An dieser Stelle noch die Berechnungen aller Statistiken im aqmet Store. Aus 21 Input Grössen werden 361 Statistiken
berechnet:

```{r include=FALSE}
aqmet_stats <- tibble::tribble(
  ~parameter, ~statistic, ~from, ~to,

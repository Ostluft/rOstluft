...
# TODO List für Tutorial:

* Wie linkt man am besten auf die Dokumentation? Auf die Reference von pkgdown auf github?
* Ist eine Vignette überhaupt die richtige Form? Wo wird sie gebaut?
  + pkgdown für Optionen durchsuchen
  + github md
...
Die `merge()` Funktion unterstützt nur 2 Argumente. Muss eine Liste gemerget werden muss man `purrr::reduce()` benützen:
